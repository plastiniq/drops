package drops.data.effects.advanced {
	 ...
	 */
	public class C_DropShadowEffect extends C_ShadowEffect {
		
		public static const description:C_EffectDescription = new C_EffectDescription('Drop Shadow');
		...
		description.push(new C_EffectProperty(C_EffectPropertyType.SLIDER, 'quality', 'Quality', null, new C_ValueRange(1, 8, 1)));
		
		public function C_DropShadowEffect() {
			inner = false;
		}
